...
To load env vars, source env_var.sh, all values are defined in .env which is supposed to be ignored by git. If you installed plugins on PyCharm, please source .env before source ./env_var.sh, type env to verify all vars have been loaded.
